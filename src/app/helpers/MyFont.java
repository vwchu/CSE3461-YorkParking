...
public class MyFont {
    ...
    private static final String LABEL_FONT_URI      = FONT_PATH + "/OpenSans/OpenSans-Semibold.ttf";    // TrueType fonts: OpenSans Semibold
    ...
    static {
        ...
        LABEL_FONT = my.makeFont(LABEL_FONT_URI);
